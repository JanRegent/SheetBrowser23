...
//https://pub.dev/packages/easy_stepper/example

class StepperInRowPage extends StatefulWidget {
  const StepperInRowPage({Key? key}) : super(key: key);

  @override
  State<StepperInRowPage> createState() => _StepperInRowPageState();
}

class _StepperInRowPageState extends State<StepperInRowPage> {
  int activeStep = 0;
